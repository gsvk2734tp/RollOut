...
public class EditUserPositive extends RollOutWeb {
    ...
    public void editUsers() throws InterruptedException {
        ...
        editUser(null, "alice@" + RandomStr.getStrDomain(252), null, RandomStr.getStr(57)); // 0 1 0 1
        editUser(null, "qqq", "qqq", "qqq"); // 0 0 1 1
        ...
        editUser("qwe4", "3!#$%&'*+-/=?^_`{|}@d", null, "qwe"); // 1 1 0 1
    ...
    public void editUser(String name, String email, String phone, String about) throws InterruptedException {
        ...
        if (name != null) {
            ...
            elements.get(0).sendKeys("1te2st");
        }
        if (email != null) {
            elements.get(1).clear();
            elements.get(1).sendKeys("2@3");
        }
        if (phone != null) {
            elements.get(2).clear();
            elements.get(2).sendKeys("+798231112");
        }
        if (about != null) {
            driver.findElement(By.cssSelector("textarea")).clear();
            driver.findElement(By.cssSelector("textarea")).sendKeys(RandomStr.getStr(128));
        }
